...
interface_image = gr.Interface(
    ...
    title="👨‍💻Made By Team 8848(Aerothon6.0)👨‍💻: RealTime Processing Image/Video Damage Detection in Aircraft from External Source too.",
    examples=path,
...
interface_video = gr.Interface(
    ...
    title="👨‍💻Made By Team 8848(Aerothon6.0)👨‍💻: RealTime Processing Image/Video Damage Detection in Aircraft from External Source",
    examples=video_path,
    cache_examples=False,
)
